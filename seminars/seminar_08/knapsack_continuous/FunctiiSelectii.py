...
# POPULATIA DE INTRARE/SELECTATA - SPECIFICATE PRIN CATE O MATRICE SI CATE UN VECTOR AL CALITATILOR - pentru situatii
# generale de reprezentare

# SELECTIA TURNEU pentru k indivizi
# selectia turneu
# I: pop,qual,dim,n,k - matricea populatiei, vectorul calitatilor, pop-dim x n, qual - dim, numarul indivizilor
# care intra in competitie
