...
# Implement the hill-climbing algorithm in order to calculate the max of the following function:
...
def fob(x):
    val = val = np.power((np.sin(x-2)),2) - x*np.cos(x)
    return val
...
# initial_pop,final_pop=p11.EA(64,0.8,0.2,20)
